package com.denzelx.haunted.graphics;
...
import com.denzelx.haunted.utils.ShaderUtils;
...
public class Shader {
	...
	public static Shader BG, BIRD, PIPE, FADE, STANDARD;
	...
	public static void loadAll(){
		...
		STANDARD = new Shader("shaders/standard.vert", "shaders/standard.frag");
		
	}
	
	public int getUniform(String name){
		if(locationCache.containsKey(name)){
			locationCache.get(name);
		}
